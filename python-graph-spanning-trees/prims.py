...
class PrimsJarnik(object):
    ...
    def __init__(self, unvisitedList) -> None:
        self.unvisitedList: list[Vertex]= unvisitedList;
        self.spanningTree: List[Edge] = [];
        self.edgeHeap: List[Edge] = [];
        self.fullCost = 0;

    def calculateSpanningTree(self, vertex: Vertex):
